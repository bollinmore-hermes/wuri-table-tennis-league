...
const results = [
  ['B-20261004-1',2,1,'final','示範資料，正式匯入前請刪除或替換'],
  ['B-20261004-2',3,0,'final','示範資料，正式匯入前請刪除或替換']
];
const snapshots = [
...
XLSX.utils.book_append_sheet(wb,sheet(['說明'],[['這是烏日桌球聯賽管理後台的 DEMO 匯入檔。Results 內含兩筆假賽果，僅供測試。'],['不可將本檔示範賽果視為官方紀錄。'],['合法團體比分為 3–0、0–3、2–1、1–2；請勿修改欄位名稱。']],[90]),'README');
